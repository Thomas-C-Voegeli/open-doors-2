  ...
  RSpec.describe User do
    ...
    context "when omitting required fields" do
      ...
      it "Doesn't save to database when state is omitted" do
        test_door_3 = User.new(country: "U.S.",
        						state: "",
        						city: "Chicago",
        						street: "W. Adams St.",
        						street_number: "233",
      ...
      it "Doesn't save to database when city is omitted" do
        test_door_4 = User.new(country: "U.S.",
        						state: "IL",
        						city: "",
        						street: "W. Adams St.",
        						street_number: "233",
      ...
      it "Doesn't save to database when street is omitted" do
        test_door_5 = User.new(country: "U.S.",
        						state: "IL",
        						city: "Chicago",
        						street: "",
        						street_number: "233",
      ...
      it "Doesn't save to database when street number is omitted" do
        test_door_6 = User.new(country: "U.S.",
        						state: "IL",
        						city: "Chicago",
        						street: "W. Adams St.",
        						street_number: "",
       ...
       it "Doesn't save to database when zipcode is omitted" do
        test_door_7 = User.new(country: "U.S.",
        						state: "IL",
        						city: "Chicago",
        						street: "W. Adams St.",
        						street_number: "233",
